...
public class AVIOutputStream {
    ...
    public AVIOutputStream(RandomAccessFile file, VideoFormat format, int bitsPerPixel) {
                ...
                switch (imgDepth) {
                    case 4: {
                        ...
                        if (!Arrays.equals(imgRGBs, previousRGBs)) {
                            ...
                            videoFrames.add(new Sample(paletteChangeChunk.chunkType, 0, offset, length - 8, true));
                            offset = getRelativeStreamPosition();
                        }
