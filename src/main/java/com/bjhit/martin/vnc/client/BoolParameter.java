...
public class BoolParameter extends VoidParameter {
	public BoolParameter(String name_, String desc_, boolean v, Configuration.ConfigurationObject co) {
	...
	public boolean setParam(String v) {
		...
		if (v == null || v.equals("1") || v.equalsIgnoreCase("on") || v.equalsIgnoreCase("true") || v.equalsIgnoreCase("yes"))
			value = true;
		else if (v.equals("0") || v.equalsIgnoreCase("off") || v.equalsIgnoreCase("false") || v.equalsIgnoreCase("no"))
			value = false;
		else {
