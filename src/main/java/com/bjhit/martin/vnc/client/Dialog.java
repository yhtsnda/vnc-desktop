...
//		setIconImage(VncViewer.frameIcon);
	...
	public boolean showDialog(Component c) {
		...
		fullScreenWindow = VncDesktop.getFullScreenWindow();
		if (fullScreenWindow != null)
			VncDesktop.setFullScreenWindow(null);
	...
	public void endDialog() {
		...
		fullScreenWindow = VncDesktop.getFullScreenWindow();
		if (fullScreenWindow != null)
			VncDesktop.setFullScreenWindow(fullScreenWindow);
	}
	...
	public void addGBComponent(JComponent c, JComponent cp, int gx, int gy, int gw, int gh, int gipx, int gipy, double gwx, double gwy, int fill, int anchor, Insets insets) {
